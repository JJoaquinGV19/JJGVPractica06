 ...
 * @author magda
 */
@WebServlet(name = "MostrarBoD", urlPatterns = {"/MostrarBoD"})
public class MostrarBoD extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
            out.println("<header>");
            out.println("<h1 class=\"titulo\">Perfil</h1>");
            out.println("<ul>");
            ...
            if((Boolean)session.getAttribute("iniciada")==true)
                out.println("<h2>Bienvenido de vuelta "+(String)session.getAttribute("nombre")+"! </h2>");
            else
